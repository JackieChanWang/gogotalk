...
function StdDraw(img,px,py,sx,sy,angle){
    DrawSth(img,framepx+px*framesx,framepy+py*framesx,framesx*sx,framesx*sy,angle);
}
...
function FrameRotale(img,px,py,sx,sy,angle,rx,ry){
    RotalePic(img,framepx+px*framesx,framepy+py*framesy,framesx*sx,framesy*sy,angle,framesx*rx,framesy*ry);
}
