...
//画线
function FrameLine(px,py,sx,sy,w,color){
	tempContext.moveTo(framepx+px*framesx,framepy+py*framesy);
	tempContext.lineTo(framepx+sx*framesx,framepy+sy*framesy);
	tempContext.strokeStyle = color;
	tempContext.lineWidth = framesx*w;
	tempContext.stroke();
}
